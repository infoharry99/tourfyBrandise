...
<body class="index-page">
  ...
  <main class="main">
      ...
      <div class="hero-container">
        ...
        <div class="hero-left">
          ...
          <a  href="https://wa.me/917982120764"
              target="_blank"
              rel="noopener noreferrer" class="btn">Book a demo</a>
        </div>
    ...
    $images = [
      ...
      '/logos/clean_logo_1.png',
      '/logos/clean_logo_2.png',
      '/logos/clean_logo_3.png',
      '/logos/clean_logo_4.png',
      '/logos/clean_logo_5.png',
      '/logos/clean_logo_6.png',
      '/logos/clean_logo_7.png',
      '/logos/clean_logo_set2_1.png',
      '/logos/clean_logo_set2_3.png',
      '/logos/clean_logo_set2_4.png',
      '/logos/clean_logo_set2_5.png',
      '/logos/clean_logo_set2_6.png',
      '/logos/clean_logo_set2_7.png',
      '/logos/clean_logo_set2_8.png',
      '/logos/clean_logo_set2_9.png',
      '/logos/clean_logo_set2_10.png',
      '/logos/clean_logo_set3_1.png',
      '/logos/clean_logo_set3_2.png',
      '/logos/clean_logo_set3_3.png',
      '/logos/clean_logo_set4_1.png',
      '/logos/clean_logo_set4_2.png',
      '/logos/clean_logo_set4_3.png',
      '/logos/clean_logo_set4_4.png',
      '/logos/clean_logo_set4_5.png',
      '/logos/clean_logo_set4_6.png',
      '/logos/clean_logo_set5_1.png',
      '/logos/clean_logo_set5_2.png',
      '/logos/clean_logo_set5_3.png',
      '/logos/clean_logo_set5_4.png',
      '/logos/clean_logo_set5_5.png',
      '/logos/clean_logo_set5_6.png',
         ...
         @php
            $cards = [
                ...
                [
                    ...
                    'skills' => ['Logo design', 'Visual identity', 'Brand guidelines']
                ],
                [
                    'title' => 'Social Media Marketing',
                    'img' => 'https://picsum.photos/id/1062/600/900',
                    'skills' => ['Content planning', 'Community management', 'Paid ads']
                ],
                [
                    'title' => 'UI / UX Design',
                    'img' => 'https://picsum.photos/id/1076/600/900',
                    'skills' => ['Wireframing', 'User research', 'Prototyping']
                ],
                [
                    'title' => 'Web Development',
                    'img' => 'https://picsum.photos/id/1084/600/900',
                    'skills' => ['Frontend development', 'Backend systems', 'Performance optimization']
                ],
            ];
            @endphp
    ...
    <section id="blog" class="flex-section">
      ...
      <div class="flex-container">
        ...
        @foreach($blogs as $index => $blog)
          <a href="{{ route('blog.details', ['id' => $blog->id]) }}" class="block">
          <div class="flex-card 
            {{ $index == 1 ? 'light' : '' }} 
            {{ $index == 2 ? 'lime' : '' }}"
