...
<body class="mode-dark">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-item">
                <a href="{{ route('admin.homepage.sections.index') }}" class="nav-link {{ Request::is('admin/homepage-sections*') ? 'active' : '' }}" >
                    <span class="nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
             ...
             <div class="nav-item">
                <a href="{{ route('admin.homepage.section.images.index') }}" class="nav-link {{ Request::is('admin/homepage-section-images*') ? 'active' : '' }}" >
                    <span class="nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                    </svg>
                    ...
                    <span class="nav-text">Hero Section Images</span>
                </a>
            </div>
            ...
            <div class="nav-item">
                <a href="{{ route('admin.portfolio-services.index') }}" class="nav-link {{ Request::is('admin/portfolio-services*') ? 'active' : '' }}" >
                    ...
                    <span class="nav-text">Portfolio Services</span>
                </a>
            </div>
            ...
            <div class="nav-item">
                <a href="{{ route('admin.logos.index') }}" class="nav-link {{ Request::is('admin/logos*') ? 'active' : '' }}" >
                    <span class="nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                    </svg>
            ...
            <div class="nav-item">
                <a href="{{ route('admin.skill.services.index') }}" class="nav-link {{ Request::is('admin/skill-services*') ? 'active' : '' }}" >
                    <span class="nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                    </svg>
                    ...
                    <span class="nav-text">Skill Services</span>
                </a>
            </div>

            <div class="nav-item">
                <a href="{{ route('admin.creators.index') }}" class="nav-link {{ Request::is('admin/creators*') ? 'active' : '' }}" >
                    <span class="nav-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                    </svg>
